...
QT_MOC_LITERAL(5, 32, 13), // "rawFrameReady"
QT_MOC_LITERAL(6, 46, 5), // "image"
QT_MOC_LITERAL(7, 52, 7), // "process"
QT_MOC_LITERAL(8, 60, 4) // "stop"

    },
    "Worker\0frameReady\0\0img\0finished\0"
    "rawFrameReady\0image\0process\0stop"
};
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->rawFrameReady((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Worker::frameReady)) {
                *result = 0;
                return;
            }
        }
        ...
        {
            using _t = void (Worker::*)(const QImage & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Worker::rawFrameReady)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Worker::frameReady(const QImage & _t1)
{
...
// SIGNAL 2
void Worker::rawFrameReady(const QImage & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
