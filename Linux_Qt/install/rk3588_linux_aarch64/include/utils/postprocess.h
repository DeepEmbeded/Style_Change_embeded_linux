...
//#define BOX_THRESH 0.5     // 原来 0.25，推荐你先试 0.5，减少误检
//#define NMS_THRESH 0.4     // 原来 0.45，微调一点也行
...
typedef struct {
    ...
    image_rect_t box;
    bool selected;
} extended_detect_result;

typedef struct {
    int count;
    extended_detect_result results[OBJ_NUMB_MAX_SIZE];
